...
| [steve-verify](../sources/steve-verify-readme.md)                                            | no (local)  | All 44 `cert16-*` templates against a real SteVe, CSMS-side actions driven over SteVe's REST API, uniqueId-correlated assertions                        |
