...
| `--ngrok-api-url <url>`             | No       | -                                       | Attach to an already-running ngrok agent (e.g. a Docker sidecar, `http://ngrok:4040`) instead of spawning one; the https tunnel forwarding to the listener port is used. Cannot be combined with the two options above. Requires `--soap-tunnel ngrok`.                                                                                                                                                                                                                                       |
