...
| --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auto-meter time curve, session-relative                               | **Yes**, and agreeing: the curve is shifted so its own first point lands on the register the run started from, so a second session never rewinds and a curve beginning above zero is not double-counted. |
