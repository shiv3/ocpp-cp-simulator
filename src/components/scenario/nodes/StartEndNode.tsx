...
const StartEndNode: React.FC<StartEndNodeProps> = ({ data, selected, nodeType }) => {
  const isStart = nodeType === "start";
  const bgColor = isStart ? "bg-green-100 dark:bg-green-900" : "bg-red-100 dark:bg-red-900";
  const borderColor = isStart ? "border-green-500" : "border-red-500";
  const textColor = isStart ? "text-green-700 dark:text-green-300" : "text-red-700 dark:text-red-300";
