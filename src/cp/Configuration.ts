...
export type IntegerConfigurationKey = {
    name: string;
    readonly: boolean;
    required: boolean;
    type: "integer";
...
export type BooleanConfigurationKey = {
    name: string;
    readonly: boolean;
    required: boolean;
    type: "boolean";
}
export type ArrayConfigurationKey = {
    name: string;
    readonly: boolean;
    required: boolean;
    type: "array";
...
export type StringConfigurationValue = {
    key: StringConfigurationKey;
    value: string;
}
export type BooleanConfigurationValue = {
    key: BooleanConfigurationKey;
    value: boolean;
}
export type ArrayConfigurationValue = {
